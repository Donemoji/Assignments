...
namespace MoveManPortalAssignment {
    ...
    internal class TexasHoldemGamePlay {
        TexasHoldemCardDeck trumpCard;
        ...
        public int GameStart(int moneyBeforeGame) {
            ...
            Console.WriteLine();
            int firstMoneyBetting;
            int secondMoneyBetting;
            int moneyBetting;
            int moneyAfterFirstBetting;
            int moneyAfterSecondBetting;
            int moneyAfterGame;

            trumpCard = new TexasHoldemCardDeck();
            ...
            firstMoneyBetting = HowMuchBet(moneyBeforeGame);

            if (firstMoneyBetting == 0) {
                Console.WriteLine();
                Console.WriteLine("폴드");
                Console.WriteLine("내 자산: {0}", moneyBeforeGame);
                Console.ReadLine();
                moneyAfterFirstBetting = moneyBeforeGame;
                return moneyAfterFirstBetting;
            ...
            moneyAfterFirstBetting = moneyBeforeGame - firstMoneyBetting;
            ...
            Console.WriteLine("======================================");
            Console.WriteLine("내 자산: {0}", moneyAfterFirstBetting);
            Console.WriteLine();
            ...
            secondMoneyBetting = HowMuchBet(moneyAfterFirstBetting);

            moneyBetting = firstMoneyBetting + secondMoneyBetting;

            //Console.WriteLine(moneyBetting);

            moneyAfterSecondBetting = moneyAfterFirstBetting - secondMoneyBetting;

            //Console.WriteLine(moneyAfterSecondBetting);

            //Console.WriteLine(moneyBeforeGame);


            Console.WriteLine();


            moneyAfterGame = WhoIsTheWinner(moneyBeforeGame, moneyAfterSecondBetting, moneyBetting, playerTrumpCard, computerTrumpCard, sharedTrumpCard);
        ...
        private int WhoIsTheWinner(int moneyBeforeGame, int moneyAfterSecondBetting, int betSize, List<int> playerCard, List<int> compCard, List<int> sharedCard) {
            ...
            //moneyAfterSecondBetting

            if (isPlayerWin) {
                moneyAfterGame = moneyAfterSecondBetting + (betSize * 2);
            ...
            if (tempStraitCheck.Count == 6) {
                for (int idx = 0; idx < 2; idx++) {
                    if (tempStraitCheck[idx + 4] - tempStraitCheck[idx] == 4) {
                        ...
                        List<int> doubleTemp = tempStraitCheck.GetRange(idx, 4 + 1);


                        if (doubleTemp.Contains(1)) {

                            jokBoNum = Math.Ceiling(doubleTemp[0] % 13.1).ToString();
                            break;
                        } else {
                            jokBoNum = Math.Ceiling(doubleTemp[4] % 13.1).ToString();
                ...
                if (tempStraitCheck[4] - tempStraitCheck[0] == 4) {
                    ...
                    List<int> doubleTemp = tempStraitCheck.GetRange(0, 4 + 1);
